...
public class SQLDao<T> implements GenericDAOI<T> {
    /**
     * <p>Save an object in the database using Hibernate with SQL database</p>
    ...
    /**
     * <p>Update an object in the database using Hibernate with SQL database</p>
    ...
    /**
     * <p>Delete an object from the database using Hibernate with SQL database</p>
    ...
    /**
     * <p>Gets an object by its id using Hibernate with SQL database</p>
    ...
    /**
     * Get all objects with the specified column value using Hibernate with SQL database
